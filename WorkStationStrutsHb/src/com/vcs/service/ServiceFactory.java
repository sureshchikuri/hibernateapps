...
public class ServiceFactory {
	...
	private static WorkStationService workStationService=null;
	...
	public static void setWorkStationService(WorkStationService workStationService) {
		ServiceFactory.workStationService = workStationService;
	}
	public static WorkStationService getWorkStationService() {
		if(workStationService==null){
			workStationService=new WorkStationServiceImpl();
		}
